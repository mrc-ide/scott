...
#'
#' This function will return a phylogeny in the `ape` package format with
#' additional attributes showing who infected whom.
#'
#' @param tfgy output of demo/epi simulation
#' @param s vector of sample times
#' @param X matrix of sample states (probabilities)
#' @return A phylogenetic tree which contains a $waifw attribute. This is a
#'    data frame containing transmission pairs and time of transmission.
#' @export
scott <- function(
  tfgy
  , s
